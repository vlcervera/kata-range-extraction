...
class TestRangeExtractionShould:
    ...
    def test_extract_with_no_ordered_numbers(self):
        ...
        assert range_extraction.extract() == "-20,-11,-10,-2,1-3,100"
